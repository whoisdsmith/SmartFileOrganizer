...
class AIServiceFactory:
    ...
    def create_analyzer(ai_service_type=None, settings_manager=None):
        ...
        if ai_service_type is None:
            ...
            if settings_manager:
                ai_service_type = settings_manager.get_setting(
                    "ai_service.service_type", "").lower()
        ...
        if ai_service_type == "openai" and openai_api_key:
            ...
            if google_api_key:
                ...
                logger.warning(
                    "No API keys found. Using Google Gemini (will show warnings)")
                return AIAnalyzer(settings_manager)
